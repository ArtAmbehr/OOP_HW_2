public class Cat extends HomeAnimal {
    ...
    protected Cat(String name, String breed, String vaccination, String color, String birthDate, int height,
            int weight, String colorEye, String wool) {
        super(name, breed, vaccination, color, birthDate, height, weight, colorEye);
        this.wool = wool;
